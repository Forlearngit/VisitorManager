...
public:
	...
	STDMETHOD(ControlStream)( const GUID *pCategory,const GUID *pType,
...
protected:
	...
	HRESULT GetEncodersByEnumerating( const REGPINMEDIUM& pinMedium, 
